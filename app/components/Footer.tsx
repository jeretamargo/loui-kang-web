...
const Footer = () => {
  return (
    <div className="flex flex-col justify-center  bg-white/10">
      <h1 className="text-[#F2ECE2] text-6xl flex font-bold text-center z-10 drop-shadow-lg  max-w-xs self-center ">
        LOUI KANG
      </h1>
